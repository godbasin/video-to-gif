...
import CanvasCrop from "../CanvasCrop/index";
import './index.css';
...
export default class LoadVideo extends Component<IProps> {
  render() {
    const {
      videoUrl, onFileChange,
      isCropping,
      cropX, setCropX, 
      cropY, setCropY,
    ...
    return (
      <div className="flex min-h-screen flex-col items-center justify-between p-24" style={{ position: 'relative', padding: 0 }}>
        { videoUrl && (
          <>
            <video
              id="video"
